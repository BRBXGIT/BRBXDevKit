...
interface BrbxTileAppearance {
     ...
     */
    @Composable fun defaultTitleMaxLines(): Int

    /**
     * How visual overflow should be handled for the title.
     */
    @Composable fun defaultTitleOverflow(): TextOverflow

    /**
     * The text style of the description.
     */
    @Composable fun defaultDescriptionStyle(): TextStyle

    /**
     * The maximum number of lines for the description.
     */
    @Composable fun defaultDescriptionMaxLines(): Int

    /**
     * How visual overflow should be handled for the description.
     */
    @Composable fun defaultDescriptionOverflow(): TextOverflow
}